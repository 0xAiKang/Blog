...
课程重点：
1. 了解有索引的情况下，join 的过程
2. 了解没有索引的情况下，join 的过程
3. 了解几种 join 算法的区别
...
这里改用 `straight_join` 让 MySQL 使用固定的连接方式执行查询，这样优化器只会按照我们指定的方式去 join。在这个语句里，t1 是驱动表，t2 是被驱动表。

现在，我们来看一下这条语句的 explain 结果。

![](https://cdn.jsdelivr.net/gh/0xAiKang/CDN/blog/images/20220826144415.png)
...
![](https://cdn.jsdelivr.net/gh/0xAiKang/CDN/blog/images/20220704212413.png)
...
2. 循环遍历这 100 行数据
3. 从每一行 R 取出字段 a 的值 $R.a
4. 执行select * from t2 where a=$R.a
5. 把返回的结果和 R 构成结果集的一行
...
![](https://cdn.jsdelivr.net/gh/0xAiKang/CDN/blog/images/20220704213413.png)
对应地，这条 SQL 语句的 explain 结果如下所示：

![](https://cdn.jsdelivr.net/gh/0xAiKang/CDN/blog/images/20220826144430.png)
...
![](https://cdn.jsdelivr.net/gh/0xAiKang/CDN/blog/images/20220704213804.png)
